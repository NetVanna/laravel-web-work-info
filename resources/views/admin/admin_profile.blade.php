                        ...
                        <div class="card-body">
                            <div class="align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{ !empty($profileData->photo) ? url('upload/user_images/' . $profileData->photo) : url('backend/assets/images/users/user-11.jpg') }}"
                                                ...
                                                <form action="{{ route('profile.store') }}" method="POST"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <textarea class="form-control" name="address">{{ old('address', $profileData->address) }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            <div class="col-lg-12 col-xl-12">
                                                                <img id="photoPreview"
                                                                    src="{{ !empty($profileData->photo) ? url('upload/user_images/' . $profileData->photo) : url('backend/assets/images/users/user-11.jpg') }}"
